...
<body>
	...
	<h2>Empleado ${empleado.nombreE} de sucursal ${empleado.idSucursal}</h2>

	<form:form action="${pageContext.request.contextPath}/GuardarE" method="POST" modelAttribute="empleado">
